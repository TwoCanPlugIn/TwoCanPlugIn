...
#ifndef TWOCAN_MAC_SLCAN_H
#define TWOCAN_MAC_SLCAN_H
...
// Implements a MacCan Interface for the SLCAN bus adapters on Mac OSX
// SLCAN adapters include Canable Cantact, Peak Systems and many others
class TwoCanMacSlcan : public TwoCanInterface, public CSerialCAN {

public:
	// Constructor and destructor
	TwoCanMacSlcan(wxMessageQueue<std::vector<byte>> *messageQueue);
	~TwoCanMacSlcan(void);
