...
#ifndef TWOCAN_MAC_KVASER_H
#define TWOCAN_MAC_KVASER_H
...
// Implements a MacCan Interface for the Kvaser LeafLight CAN bus adapter on Mac OSX
class TwoCanMacKvaser : public TwoCanInterface, public CKvaserCAN {

public:
	// Constructor and destructor
	TwoCanMacKvaser(wxMessageQueue<std::vector<byte>> *messageQueue);
	~TwoCanMacKvaser(void);
