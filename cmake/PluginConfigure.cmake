...
if(NOT SKIP_VERSION_CONFIG)
    ...
    configure_file(${CMAKE_CURRENT_LIST_DIR}/in-files/version.h.in ${BUILD_INCLUDE_PATH}/include/twocanversion.h)
...
if(WIN32)
    if(MSVC)
        ...
        set(CMAKE_CXX_FLAGS_RELEASE "/MP /MD  /O2  /Ob2 /D NDEBUG /Zi /EHa /D_DISABLE_CONSTEXPR_MUTEX_CONSTRUCTOR")
        set(CMAKE_CXX_FLAGS_RELWITHDEBINFO "/MP /MD  /O2  /Ob1 /D NDEBUG /Zi /EHa /D_DISABLE_CONSTEXPR_MUTEX_CONSTRUCTOR")
