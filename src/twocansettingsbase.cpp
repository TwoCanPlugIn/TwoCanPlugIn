...
TwoCanSettingsBase::TwoCanSettingsBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	wxBoxSizer* sizerPanelWaypoints;
	sizerPanelWaypoints = new wxBoxSizer( wxVERTICAL );

	labelWaypoints = new wxStaticText( panelWaypoints, wxID_ANY, wxT("Waypoints"), wxDefaultPosition, wxDefaultSize, 0 );
	labelWaypoints->Wrap( -1 );
	sizerPanelWaypoints->Add( labelWaypoints, 0, wxALL, 5 );

	wxArrayString chkListWaypointsChoices;
	chkListWaypoints = new wxCheckListBox( panelWaypoints, wxID_ANY, wxDefaultPosition, wxDefaultSize, chkListWaypointsChoices, 0 );
	sizerPanelWaypoints->Add( chkListWaypoints, 1, wxALL|wxEXPAND, 5 );

	buttonExport = new wxButton( panelWaypoints, wxID_ANY, wxT("Export"), wxDefaultPosition, wxDefaultSize, 0 );
	sizerPanelWaypoints->Add( buttonExport, 0, wxALL, 5 );


	panelWaypoints->SetSizer( sizerPanelWaypoints );
	panelWaypoints->Layout();
	sizerPanelWaypoints->Fit( panelWaypoints );
	...
	notebookTabs->Connect( wxEVT_COMMAND_NOTEBOOK_PAGE_CHANGED, wxNotebookEventHandler( TwoCanSettingsBase::OnPageChanged ), NULL, this );
	...
	dataGridNetwork->Connect( wxEVT_GRID_CELL_LEFT_DCLICK, wxGridEventHandler( TwoCanSettingsBase::OnDoubleClick ), NULL, this );
	...
	panelWaypoints->Connect( wxEVT_SET_FOCUS, wxFocusEventHandler( TwoCanSettingsBase::OnWaypointFocus ), NULL, this );
	chkListWaypoints->Connect( wxEVT_COMMAND_CHECKLISTBOX_TOGGLED, wxCommandEventHandler( TwoCanSettingsBase::OnWaypointCheck ), NULL, this );
	chkListWaypoints->Connect( wxEVT_RIGHT_DOWN, wxMouseEventHandler( TwoCanSettingsBase::OnWaypointRightClick ), NULL, this );
	buttonExport->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TwoCanSettingsBase::OnWaypointExport ), NULL, this );
...
TwoCanSettingsBase::~TwoCanSettingsBase()
{
	...
	notebookTabs->Disconnect( wxEVT_COMMAND_NOTEBOOK_PAGE_CHANGED, wxNotebookEventHandler( TwoCanSettingsBase::OnPageChanged ), NULL, this );
	...
	dataGridNetwork->Disconnect( wxEVT_GRID_CELL_LEFT_DCLICK, wxGridEventHandler( TwoCanSettingsBase::OnDoubleClick ), NULL, this );
	...
	panelWaypoints->Disconnect( wxEVT_SET_FOCUS, wxFocusEventHandler( TwoCanSettingsBase::OnWaypointFocus ), NULL, this );
	chkListWaypoints->Disconnect( wxEVT_COMMAND_CHECKLISTBOX_TOGGLED, wxCommandEventHandler( TwoCanSettingsBase::OnWaypointCheck ), NULL, this );
	chkListWaypoints->Disconnect( wxEVT_RIGHT_DOWN, wxMouseEventHandler( TwoCanSettingsBase::OnWaypointRightClick ), NULL, this );
	buttonExport->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TwoCanSettingsBase::OnWaypointExport ), NULL, this );
